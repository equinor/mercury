...
class TestCase(unittest.TestCase):
    def test_multiflash(self):
        number_of_components, component_ids, temprature, pressure, composition = read_dat(
            filename="dat/Asg_20VA001.dat")
    ...
    def test_cpe(self):
        ne, number_of_components, number_of_reactions, component_ids, feed_composition, formula_matrix, stoichiometric_matrix = read_reaction(
            filename="Reactions/AsgB_20VA001.dat")
