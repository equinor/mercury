...
Note that the API Dockerfile needs read access to the private repository `github.com/equinor/gpa-libhg` during build.
...
_Infrastructure-as-Code_-language for Azure. All bicep-files can be found at `./IaC`.
